...
const Wizard: React.FC = () => {
	...
	const getFlowState = useCallback(async () => {
	...
	}, [janka.attestation, restart, score?.score])


	useEffect(() => {
		getFlowState();
		if (!restart && janka.attestation && janka.attestation.finalizationTime.gt(0)) {
	...
	}, [janka.attestation, address, restart, getFlowState])
